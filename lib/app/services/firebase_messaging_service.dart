...
class FireBaseMessagingService extends GetxService {
  ...
  void _notificationsBackground(message) {
  ...
  void _newMessageNotificationBackground(message) {
  ...
  void _bookingNotification(message) {
  ...
  void _newMessageNotification(message) {
